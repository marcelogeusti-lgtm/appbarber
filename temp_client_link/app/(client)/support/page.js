            ...
            {sent ? (
                <div className="bg-emerald-500/10 border border-emerald-500/20 rounded-3xl p-8 text-center animate-in fade-in zoom-in duration-300">
                    ...
                    <button
                        ...
                        className="text-emerald-500 font-bold uppercase tracking-widest text-xs hover:text-emerald-400 transition"
                    >
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                    ...
                    <div className="space-y-2">
                        ...
                        <textarea
                            ...
                            className="w-full bg-[#111111] border border-slate-800 rounded-xl py-4 px-4 text-sm text-white focus:outline-none focus:border-emerald-500 focus:ring-1 focus:ring-emerald-500 transition resize-none"
