...
async function generateMockData() {
    try {
        console.log('--- GENERATING PERFECT MOCK DATA V3 ---');
        ...
        const clients = [];
        for (let i = 1; i <= 50; i++) {
            const phone = `1197777${String(i).padStart(4, '0')}`;
        ...
        // 2. Clear existing appointments/orders for this shop
        ...
        for (let i = 0; i < 30; i++) {
            ...
            const apt = await prisma.appointment.create({
                data: {
                    ...
                    notes: 'Agendamento demonstrativo'
                }
            });
        ...
        console.log(`Generated snapshot: Today ok.`);
