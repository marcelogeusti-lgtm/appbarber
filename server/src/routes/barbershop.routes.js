...
const { getBarbershopBySlug, updateBarbershop, listBarbershops, searchBarbershops, updateSaasPlan, getMyBarbershop, toggleFavorite, checkFavoriteStatus, getMyFavorites } = require('../controllers/barbershop.controller');
