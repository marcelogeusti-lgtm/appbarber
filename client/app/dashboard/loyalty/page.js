...
export default function LoyaltyPage() {
    ...
    return (
        ...
        >
            {/* Header Section */}
            <header className="relative p-8 rounded-3xl overflow-hidden border border-border bg-card shadow-2xl shadow-primary/5">
            ...
            <form onSubmit={handleSubmit} className="grid grid-cols-1 lg:grid-cols-3 gap-8">
                ...
                <div className="lg:col-span-2 space-y-6">
                    <motion.div variants={itemVariants} className="p-8 rounded-3xl border border-border bg-card shadow-xl relative overflow-hidden">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                            ...
                            <div className="space-y-3">
                                ...
                                <div className="relative group">
                                    <input
                                        ...
                                        className="w-full p-5 bg-background/50 border border-border rounded-2xl focus:ring-4 ring-primary/20 outline-none font-black text-foreground text-2xl transition-all group-hover:border-primary/30"
                                    />
                            ...
                            <div className="md:col-span-2 space-y-3">
                                ...
                                <textarea
                                    ...
                                    className="w-full p-6 bg-background/50 border border-border rounded-2xl focus:ring-4 ring-primary/20 outline-none font-bold text-foreground text-sm resize-none transition-all hover:border-primary/30 placeholder:opacity-30"
                                />
                            </div>
                        </div>
                ...
                <div className="space-y-6">
                    <motion.div variants={itemVariants} className="p-8 rounded-3xl border border-border bg-card relative overflow-hidden">
                        ...
                        {/* Mockup Card */}
                        <div className="bg-background rounded-2xl border border-border p-6 space-y-6 shadow-2xl scale-100 origin-top transition-transform hover:scale-[1.03]">
                            <div className="flex justify-between items-center">
                                <div>
                                    <p className="text-[10px] font-black uppercase text-primary tracking-widest mb-1">Seus Pontos</p>
                                    <div className="text-4xl font-black text-foreground leading-none">80</div>
                                </div>
                            ...
                            <div className="pt-4 border-t border-border space-y-2">
                                <p className="text-xs text-foreground font-bold uppercase tracking-tight flex items-center gap-2">
                    ...
                    {/* Quick Tips */}
                    <motion.div variants={itemVariants} className="p-6 rounded-3xl border border-border bg-card">
