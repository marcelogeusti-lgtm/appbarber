    ...
    return (
        <div className="space-y-10 pb-20">
            <header className="flex flex-col md:flex-row justify-between items-start md:items-center gap-6 bg-card p-10 rounded-xl border border-border shadow-sm relative overflow-hidden">
                ...
                <div className="bg-background/50 border border-border px-6 py-4 rounded-xl relative z-10 flex items-center gap-3">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
                <div className="lg:col-span-2 space-y-8">
                    ...
                    <div className="space-y-6">
                        ...
                        {[
                            ...
                            <div key={i} className="bg-card p-8 rounded-xl border border-border hover:border-primary/30 transition-all group flex gap-6">
                                <div className="flex-shrink-0 w-14 h-14 bg-muted rounded-xl flex items-center justify-center border border-border group-hover:bg-primary/10 transition-colors">
                ...
                <div className="space-y-8">
                    <div className="bg-primary p-10 rounded-xl text-primary-foreground shadow-2xl shadow-primary/20 relative overflow-hidden group">
                    ...
                    <div className="bg-card p-8 rounded-xl border border-border shadow-sm text-center">
                        ...
                        <button className="w-full py-4 bg-muted border border-border rounded-xl text-[10px] font-black text-foreground uppercase tracking-widest hover:bg-primary hover:text-primary-foreground hover:border-primary transition-all active:scale-95">
