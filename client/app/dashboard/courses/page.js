...
function CourseCard({ course }) {
    return (
        <div className="group bg-[#151821] border border-white/5 rounded-2xl overflow-hidden transition-all duration-300 hover:shadow-xl hover:shadow-emerald-500/5 hover:-translate-y-1 hover:border-emerald-500/30 flex flex-col">
            ...
            <div className="p-5 flex-1 flex flex-col">
                <div className="flex items-center gap-2 mb-3">
                    ...
                    <span className="text-[9px] font-bold tracking-widest uppercase text-slate-400">{course.category || 'Curso'}</span>
                </div>
                ...
                <p className="text-xs text-slate-400 line-clamp-2 mb-6 leading-relaxed flex-1">{course.description || 'Sem descrição disponível.'}</p>
