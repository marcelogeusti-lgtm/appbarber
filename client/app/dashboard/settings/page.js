...
import { Settings, Save, MapPin, Phone, Hash, CreditCard, LayoutGrid } from 'lucide-react';
...
export default function SettingsPage() {
    ...
    const [activeTab, setActiveTab] = useState('general'); // 'general' | 'payments'
    ...
    return (
        <div className="max-w-5xl mx-auto space-y-8">
            ...
            <div className="flex items-center gap-4">
                ...
                <div>
                    <h1 className="text-2xl font-black text-white uppercase tracking-tighter">Configurações</h1>
                    <p className="text-slate-500 text-sm font-medium">Gerencie sua barbearia e integrações.</p>
                </div>
            </div>

            {/* TAB NAVIGATION */}
            <div className="flex p-1 bg-slate-900/50 rounded-2xl border border-slate-800 w-fit">
                <button
                    onClick={() => setActiveTab('general')}
                    className={`flex items-center gap-2 px-6 py-3 rounded-xl text-xs font-bold uppercase tracking-widest transition-all ${activeTab === 'general' ? 'bg-emerald-500 text-white shadow-lg shadow-emerald-900/20' : 'text-slate-500 hover:text-white'}`}
                >
                ...
                <button
                    ...
                    className={`flex items-center gap-2 px-6 py-3 rounded-xl text-xs font-bold uppercase tracking-widest transition-all ${activeTab === 'payments' ? 'bg-emerald-500 text-white shadow-lg shadow-emerald-900/20' : 'text-slate-500 hover:text-white'}`}
                >
