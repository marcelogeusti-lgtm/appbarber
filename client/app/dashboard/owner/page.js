    ...
    return (
        <div className="space-y-6 pb-12">
            ...
            <div className="grid grid-cols-2 lg:grid-cols-4 gap-4">
                ...
                <ManagementCard label="Lucro" value={formatBRL(kpis.estimatedProfit)} desc="Resultado líquido" icon={Zap} color="success" />
            </div>
...
function ManagementCard({ label, value, desc, icon: Icon, color = 'muted', trend }) {
    const colors = {
        ...
        success: 'bg-green-500/10 border-green-500/30 text-green-500 shadow-md shadow-green-500/5',
    };
