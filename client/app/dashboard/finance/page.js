    ...
    return (
        <div className="space-y-8 pb-20">
            <header className="flex flex-col md:flex-row justify-between items-start md:items-center gap-6 bg-[#111827] p-8 rounded-3xl border border-slate-800 shadow-sm">
                ...
                {/* GLOBAL TABS or PERIOD SELECTOR based on Tab */}
                {activeTab === 'dashboard' && (
            ...
            <div className="flex p-1 bg-slate-900/50 rounded-2xl border border-slate-800 w-fit">
                <button
                    ...
                    className={`flex items-center gap-2 px-6 py-3 rounded-xl text-xs font-bold uppercase tracking-widest transition-all ${activeTab === 'dashboard' ? 'bg-emerald-500 text-white shadow-lg shadow-emerald-900/20' : 'text-slate-500 hover:text-white'}`}
                >
                ...
                <button
                    ...
                    className={`flex items-center gap-2 px-6 py-3 rounded-xl text-xs font-bold uppercase tracking-widest transition-all ${activeTab === 'settings' ? 'bg-emerald-500 text-white shadow-lg shadow-emerald-900/20' : 'text-slate-500 hover:text-white'}`}
                >
            ...
            {activeTab === 'dashboard' && (
                <>
                    {loading ? <div className="p-8 text-center text-slate-500 animate-pulse uppercase font-black tracking-widest text-xs">Sincronizando dados financeiros...</div> : (
                        <>
