            ...
            <header className="relative h-64 w-full overflow-hidden group">
                ...
                <div className="absolute top-6 left-1/2 -translate-x-1/2 sm:left-6 sm:translate-x-0 z-20 flex items-center gap-4 w-full justify-between sm:justify-start px-4 sm:px-0">
                    ...
                    <div className="flex gap-3 sm:hidden">
                        ...
                        <button onClick={onShare} className="w-10 h-10 bg-black/50 backdrop-blur-md rounded-full flex items-center justify-center text-white border border-white/10 hover:text-emerald-500 transition">
                ...
                <div className="absolute -bottom-12 left-0 right-0 z-20 px-6 flex flex-col items-center text-center pointer-events-none">
                    ...
                    <div className="flex items-center gap-2 text-slate-300 text-[10px] font-bold uppercase tracking-widest max-w-[80%] drop-shadow-md pointer-events-auto cursor-pointer hover:text-emerald-500 transition" onClick={onOpenMap}>
