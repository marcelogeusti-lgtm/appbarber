    ...
    return (
        ...
        >
                        ...
                        <div className="flex items-center gap-6 relative z-10">
                            ...
                            <div className="space-y-1">
                                <div className="flex items-center gap-3">
                                    ...
                                    {item.active && (
                                        <span className="flex items-center gap-1 px-3 py-1 bg-primary/10 text-primary text-[8px] font-black uppercase tracking-[0.2em] rounded-full border border-primary/20">
            ...
            <motion.div variants={itemVariants} className="pt-8 flex justify-center">
                <div className="flex items-center gap-4 px-8 py-4 bg-primary/5 rounded-3xl border border-primary/10">
                    <ShieldCheck className="w-5 h-5 text-primary" strokeWidth={2.5} />
                    <span className="text-[10px] text-primary/80 font-black uppercase tracking-[0.2em] text-center">
                                    ...
                                    sessions.map((session) => (
                                        <div key={session.id} className="bg-white/5 border border-white/5 rounded-3xl p-6 flex flex-col sm:flex-row items-start sm:items-center justify-between gap-6 hover:border-white/10 transition-colors group">
                                            <div className="flex items-center gap-5 w-full">
                                                <div className={`w-14 h-14 rounded-2xl flex items-center justify-center flex-shrink-0 transition-colors ${session.isCurrent ? 'bg-primary/10 text-primary border border-primary/20' : 'bg-white/5 text-slate-500 border border-white/10 group-hover:bg-white/10'}`}>
                                                ...
                                                <div className="flex-1 min-w-0">
                                                    <div className="flex flex-col sm:flex-row sm:items-center gap-2 sm:gap-4 mb-1.5">
                                                        ...
                                                        {session.isCurrent && (
                                                            <span className="px-2.5 py-0.5 bg-primary/10 text-primary text-[8px] font-black uppercase tracking-[0.2em] rounded-full border border-primary/20 w-max">
                                                                Sessão Atual
                                                            </span>
                                                        )}
                                                    </div>
