                    ...
                    >
                        <div className="bg-[#0b0f19] rounded-[22px] p-5 h-full flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 relative overflow-hidden">
                            ...
                            <div className="flex gap-4 items-start w-full sm:w-auto relative z-10">
                                ...
                                <div
                                    className="relative w-20 h-20 rounded-2xl overflow-hidden group/img cursor-pointer shrink-0 border border-emerald-500/20"
                                    onClick={(e) => {
                                        e.stopPropagation();
                                ...
                                >
                                    {service.imageUrl ? (
                                        ...
                                        <div className="w-full h-full bg-slate-800 flex items-center justify-center">
                                            <Scissors className="w-8 h-8 text-emerald-500/40" />
                                        </div>
                                    )}
                            ...
                            <div className="w-full sm:w-auto flex justify-end mt-2 sm:mt-0 relative z-10">
                                <button
                                    ...
                                    className="px-4 py-2 bg-emerald-500 hover:bg-emerald-600 text-white text-[10px] font-black uppercase rounded-xl transition-all shadow-lg shadow-emerald-500/10 active:scale-95"
                                >
                                    AGENDAR
                                </button>
                            </div>
            ...
            {selectedService && (
                <div className="fixed inset-0 z-50 bg-black/90 backdrop-blur-sm flex items-center justify-center p-6 animate-in fade-in">
                    <div className="bg-[#111] w-full max-w-sm rounded-[2rem] border border-slate-800 p-6 relative shadow-2xl animate-in zoom-in-95">
                        ...
                        <p className="text-emerald-400 font-black text-2xl mb-4">{formatCurrency(selectedService.price)}</p>
                        ...
                        <button
                            ...
                            className="w-full bg-emerald-500 text-white py-4 rounded-xl font-black text-sm uppercase tracking-widest hover:bg-emerald-600 transition-all shadow-lg shadow-emerald-500/20 active:scale-[0.98]"
                        >
                            Agendar Agora
                        </button>
                    </div>
