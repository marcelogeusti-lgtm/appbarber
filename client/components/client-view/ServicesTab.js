...
import { Scissors, Clock, Banknote, ChevronRight, X, Search } from 'lucide-react';
            ...
            <div className="space-y-4 pb-24 animate-in fade-in slide-in-from-bottom-4">
                ...
                <div className="relative mb-6">
                    ...
                    <input
                        ...
                        className="w-full bg-[#0b0f19] border border-white/10 rounded-2xl py-4 pl-12 pr-4 text-white placeholder:text-slate-600 focus:outline-none focus:border-primary/50 transition-all font-bold text-sm"
                    />
                </div>
                ...
                {filteredServices.length > 0 ? (
                    ...
                    <div className="text-center py-20 bg-[#0b0f19] rounded-3xl border border-white/5">
                        ...
                        <p className="text-slate-500 font-bold uppercase tracking-widest text-xs">Nenhum serviço corresponde à sua busca.</p>
                    </div>
                )}
            </div>
