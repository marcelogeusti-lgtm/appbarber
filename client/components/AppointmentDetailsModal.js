...
export default function AppointmentDetailsModal({
    ...
    const modalContent = (
        <div className="fixed inset-0 z-[60] flex items-center justify-center p-4 animate-in fade-in duration-200">
            ...
            {/* Modal Content */}
            <div className="relative bg-[#111827] border border-slate-800 w-full max-w-md rounded-xl shadow-2xl overflow-hidden flex flex-col animate-in zoom-in-95 duration-200">
                            ...
                            {isProfessional ? (
                                !showPaymentSelector ? (
                                    <button
                                        ...
                                        className="w-full bg-primary hover:bg-primary/90 text-white py-4 rounded-xl font-black uppercase tracking-widest transition-all shadow-lg shadow-primary/20 flex items-center justify-center gap-2"
                                    >
                                ...
                                <button
                                    ...
                                    className="w-full py-4 rounded-xl border border-red-500/20 text-red-500 font-black text-[10px] uppercase tracking-widest hover:bg-red-500 hover:text-white transition-all flex items-center justify-center gap-2 disabled:opacity-50"
                                >
