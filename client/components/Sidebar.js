...
import {
    ...
    PlayCircle, Database, UploadCloud, Ticket, ListOrdered, Trophy, Boxes, ShieldX, Gauge, Repeat, Megaphone, ClipboardList, Cake
} from 'lucide-react';
            ...
            `}>
                ...
                <nav className={`flex-1 overflow-y-auto py-4 px-3 space-y-4 scrollbar-thin scrollbar-thumb-muted-foreground/20 ${isLocked ? 'opacity-50 pointer-events-none grayscale' : ''}`}>
                    ...
                    <MenuGroup title="Vendas" id="vendas" icon={Receipt}>
                        ...
                        <MenuItem href="/dashboard/surveys" icon={Gauge} label="Pesquisa (NPS)" badge="Novo" />
                        <MenuItem href="/dashboard/campaigns" icon={Megaphone} label="Notícias & Promoções" badge="Novo" />
                        <MenuItem href="/dashboard/birthdays" icon={Cake} label="Aniversariantes" badge="Novo" />
                    </MenuGroup>
