...
export default function ToastActivity() {
    ...
    return (
        ...
        >
            {currentToast && (
                <div className="bg-gray-50 rounded-xl shadow-2xl p-4 pr-6 flex items-center gap-3 border border-gray-200 cursor-pointer hover:scale-105 transition-transform">
