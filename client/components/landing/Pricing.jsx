    ...
    const plans = [
        {
            ...
            desc: "O essencial para quem está começando e quer profissionalismo.",
            features: [
                "Agenda Maestro Ilimitada",
        ...
        },
        {
            ...
            desc: "O equilíbrio perfeito para barbearias em crescimento.",
            features: [
                "Tudo do plano Start",
                "Até 3 Profissionais",
                "WhatsApp Automation",
        ...
        },
        {
            ...
            desc: "Poder total para impérios e grandes barbearias.",
            features: [
                "Tudo do plano PRO",
        ...
        <section className="py-32 bg-[#050505] relative overflow-hidden" id="pricing">
            ...
            <div className="container mx-auto px-4 relative z-10">
                <div className="text-center max-w-4xl mx-auto mb-24">
                    ...
                    >
                        ...
                        <div className="flex items-center justify-center gap-6 mt-16 font-body">
                            <span className={`text-[12px] font-black uppercase tracking-[0.2em] transition-colors ${!isYearly ? 'text-white' : 'text-slate-500'}`}>Mensal</span>
                            <button
                                ...
                                <div className={`card-premium relative h-full border ${plan.recommended ? 'border-primary border-2 shadow-[0_40px_100px_rgba(77,114,228,0.15)] ring-4 ring-primary/5' : 'border-white/[0.08] shadow-2xl'} ${plan.bg} flex flex-col group transition-all duration-700 hover:border-white/20`}>
                                    ...
                                    {plan.recommended && (
                                        <div className="absolute -top-6 left-1/2 -translate-x-1/2 px-6 py-2 bg-primary rounded-full flex items-center gap-2.5 shadow-[0_15px_30px_rgba(77,114,228,0.3)] animate-pulse">
                                            ...
                                            <span className="font-body text-[10px] font-black text-white uppercase tracking-[0.3em]">Recomendado</span>
                                        </div>
                                    )}
                ...
                <div className="mt-24 text-center">
                    <p className="font-body text-slate-500 text-[10px] font-black uppercase tracking-[0.4em] mb-4">Teste grátis por 7 dias. Cancele quando quiser.</p>
                </div>
            </div>
        </section>
    );
